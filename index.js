...
app.use(cors({
  credentials: true,
  origin: ['http://localhost:3000', 'http://localhost:3001', 'https://admin.bestprice4deals.com', 'https://www.bestprice4deals.com', 'https://bestprice4deals.com', 'https://money-tracker-admin.vercel.app']
}));
