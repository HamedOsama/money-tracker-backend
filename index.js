...
app.use(cors({ credentials: true, origin: ['http://localhost:3000', 'http://localhost:3001', 'https://kit-hardware-center.com', 'https://www.kit-hardware-center.com', 'https://kit-hardware.vercel.app', 'https://admin.kit-hardware-center.com'] }));
